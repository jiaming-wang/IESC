...
parser.add_argument('--data_dir',default='./market_rename',type=str, help='training dir path')
...
parser.add_argument('--PCB', action='store_true',default=True, help='use PCB+ResNet50' )
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val':
                ...
                if epoch%10 == 9:
                    ...
                    # model.module.load_state_dict(last_model_wts)
                draw_curve(epoch)
