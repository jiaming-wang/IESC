...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='./model/ft_ResNet50_pcb_market_e')
    ...
    print(len(train_dataloader.dataset.classes))
    model = utils.load_network(PCB(len(train_dataloader.dataset.classes)),
