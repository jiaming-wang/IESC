...
parser.add_argument('--gpu_ids',default='0', type=str,help='gpu_ids: e.g. 0  0,1,2  0,2')
parser.add_argument('--which_epoch',default='last', type=str, help='0,1,2,3...or last')
parser.add_argument('--test_dir',default='./market_rename/',type=str, help='./test_data')
parser.add_argument('--name', default='ft_ResNet50', type=str, help='save model path')
parser.add_argument('--batchsize', default=32, type=int, help='batchsize')
parser.add_argument('--use_dense', action='store_true', help='use densenet121' )
parser.add_argument('--PCB', action='store_true', default=True, help='use PCB' )
...
def load_network(network):
    ...
    save_path = os.path.join('./model',name,'net_59.pth')
...
# create new OrderedDict that does not contain `module.`
    ...
    for k, v in state_dict.items():
        # print(k)
        # k1 = 'module.' + k# remove `module.`
        # k1 = k1.replace('module.classifier.','module.classifier' + str(i) + '.')
        # print(k1)
...
model_structure.classifier0 = nn.Sequential()
model_structure.classifier1 = nn.Sequential()
model_structure.classifier2 = nn.Sequential()
model_structure.classifier3 = nn.Sequential()
model_structure.classifier4 = nn.Sequential()
model_structure.classifier5 = nn.Sequential()
