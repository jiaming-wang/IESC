...
parser.add_argument('--test_dir',default='./duke_rename',type=str, help='./test_data')
...
def load_network(network):
    ...
    for k, v in state_dict.items():
        ...
        # print(k_)
        new_state_dict[k_] = v
    network.load_state_dict(new_state_dict,False)
    return network
...
# model = torch.nn.DataParallel(model_structure, device_ids=gpu_ids)
